var mfaProjects = [
	{"#foods-great-adventure-div" : {
		...
		basics : {"Project site": "<a class='links' href='http://foodsgreatadventure.com' target='_blank'> Project site</a> &nbsp | &nbsp <a href='https://github.com/danaavesar/FoodsGreatAdventure' target='_blank'> Code</a> &nbsp | &nbsp Fall 2014 Major Studio 1 Final Project ", "Built with" : "Built with: Javascript, Jquery, p5.js, CSS, HTML, Sass, PHP, MYSQL", "role":"Illustration, Design, Development, Illustration, Concept" },
		...
		process: "I found inspiration in many children's books, The Magic School Bus, Ipad applications like the ones from Toca Boca, and The Fantastic Flying Books of Mr. Morris Lessmore. I was also inspired by the <a href='https://www.ted.com/talks/mac_barnett_why_a_good_book_is_a_secret_door?language=en' target='_blank' >TED Talk </a> of children's book writer, Mac Barnett, who says that art is the intersection between the truth and lies. </br> This project actually was based off a <a href='http://b.parsons.edu/~avesd617/nutrition_website/' target='_blank'> project I did for my web bootcamp class </a> when I started my Masters degree. I created a web infographic of how nutrients affect our bodies. <div class='image-holder'><img class='process-img' src='img/mfadt/foods-great-adventure/bootcamp-nutrition-website.gif'/></div> <p> For Food's Great Adventure I imagined a much more interactive version of a similar infographic. After doing alot of research about the digestion system, I started to sketch out the user flow and brainstorm the metaphors and interactions I can create. </p><div class='dragdrop'> </div> <p> Design mood board: </p> <img class='process-img' src='img/mfadt/foods-great-adventure/sketches/design_inspiration.jpg'/> <p>After illustrating came the challenge of coding. This was one of my first Javascript heavy projects and it was so rewarding to research and learn as I went, in order to make the interactions I dreamt of come to life. After coding came a lot of iterations in which I tweaked the word choices to match my target age group of 6-8 year olds, as well as iterated over the user experience and instruction set. Known problems: many kids like to go out of order, and currently going out of order messes up the instructions for moving forward. This is something I would look forward to iterating upon, as well as adding a back arrow button.  </p>",
		code: "The animations are a combination of animated Gifs, PNG Sequence animations, and SNAP library SVG animations. To create the PNG animations such as the mouth chewing, I illustrated each frame and animated it in After Effects. I the exported the frames as a PNG sequence, and I mapped the mouse movement to each frame in the animation, changing the src attribute of the mouth with each frame. I used the SVG library Snap only for animating the squueze of the sponge and the squeeze of the saliva gland. This library allows you to animate between two different svg paths. For the stomach animation I used p5 js to code the movement of the food and the scissors that follow it.",
		category: "Web"
		}
	},
	{"#splaycious-div" : {
